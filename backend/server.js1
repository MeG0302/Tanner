...
app.get('/api/markets', async (req, res) => {
  ...
  // --- NEW: Filter to only show currently open markets ---
  ...
  console.log(`Filtered ${allNormalizedMarkets.length} markets down to ${sortedMarkets.length} currently open markets.`);
