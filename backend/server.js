...
// Get unified markets (general endpoint with optional category query param)
app.get('/api/unified-markets', async (req, res) => {
  const category = req.query.category || 'All';
  const startTime = Date.now();
  console.log(`[API] Received request for unified markets (category: ${category})`);
...
// Get unified markets by category (legacy endpoint for backward compatibility)
