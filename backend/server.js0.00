...
const CONFIG = {
  // Pagination settings
  FETCH_STRATEGY: 'SMART', // 'SMART' (2 pages), 'FULL' (all pages), 'MINIMAL' (1 page)
  MAX_PAGES: {
    SMART: 2,    // Fetch 2000 markets (2 pages × 1000) - RECOMMENDED
    FULL: 10,    // Fetch up to 10,000 markets (10 pages) - SLOW
 ...
 */
async function fetchPolymarketData(maxPages = 2) {
  try {
