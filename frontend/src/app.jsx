...
export const fetchMarketsByCategory = async (category, setToastMessage) => {
  console.log(`Fetching top 25 markets for category: ${category}`);
...
function MarketCard({ market, onMarketClick }) {
  ...
  if (outcomes.length === 0) {
    return (
      <div className="bg-blue-100 border border-blue-300 rounded-lg shadow-sm p-4 h-auto">
        <span className="text-xs text-blue-500 uppercase">{market.category}</span>
  ...
  return (
    <div
      className="bg-blue-100 border border-blue-300 rounded-lg shadow-sm hover:shadow-md transition-shadow cursor-pointer p-4 h-auto"
