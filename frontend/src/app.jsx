      ...
      <div className="flex items-start gap-6 mb-6">
        ...
        <div className="flex-1">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <span className={`text-sm ${textSecondary}`}>Historic Volume:</span>
...
function MarketCard({ market, onMarketClick, theme = 'dark' }) {
  ...
  if (outcomes.length === 0) {
    return (
      <div className={`rounded-lg shadow-sm p-4 h-auto ${theme === 'dark' ? 'bg-[#1A2332] border border-gray-700' : 'bg-green-50/30 backdrop-blur-sm border border-green-200/50'}`}>
  ...
  return (
    <div
      className={`rounded-lg shadow-sm hover:shadow-md transition-shadow cursor-pointer p-4 h-auto ${theme === 'dark' ? 'bg-[#1A2332] border border-gray-700 hover:border-blue-500/50' : 'bg-green-50/30 backdrop-blur-sm border border-green-200/50 hover:border-green-400/60'}`}
