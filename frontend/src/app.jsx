...
const getLogo = (platform) => {
  // FIX: Added leading slash to paths to load from 'public' folder
  switch (platform) {
    case 'Limitless':
      return "/fLHeW0Ji_400x400.jpg";
    case 'Polymarket':
...
function useSimulatedWebSocket(markets, setMarkets, handleAddNotification) {
  ...
  }, [markets.length > 0]); // FIX: Only run when markets.length goes from 0 to > 0
}
