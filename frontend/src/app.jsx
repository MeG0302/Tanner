...
function TimeProgressBar({ startDate, endDate, theme = 'dark' }) {
  ...
  const bars = Array.from({ length: totalBars }, (_, i) => {
    ...
    return (
      <span
        key={i}
        className={`${isFilled ? 'text-green-400' : 'text-gray-600'}`}
      >
        |
      </span>
    );
            ...
            {market.endDate && (
              <div className="flex items-center gap-4">
                <span className="text-sm text-gray-400">
                  Resolution: {formatResolutionDate(market.endDate)}
                </span>
                <TimeProgressBar 
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="relative w-14 h-7 bg-gray-700 rounded-full transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
...
function TickerTape({ newsItems, theme = 'dark' }) {
  return (
    <div className={`border-b h-12 flex items-center overflow-hidden ${theme === 'dark' ? 'bg-gray-900 border-gray-800' : 'bg-green-50 border-green-200'}`}>
...
function MarketCard({ market, onMarketClick, theme = 'dark' }) {
  ...
  return (
    <div
      className={`rounded-lg shadow-sm hover:shadow-md transition-shadow cursor-pointer p-4 h-auto ${theme === 'dark' ? 'bg-[#1A2332] border border-gray-700 hover:border-blue-500/50' : 'bg-white border border-gray-200 hover:border-green-500/50'}`}
