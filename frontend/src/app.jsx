...
function MarketCard({ market, onMarketClick, theme = 'dark' }) {
  ...
  if (outcomes.length === 0) {
    return (
      <div className={`rounded-lg shadow-sm p-4 h-auto ${theme === 'dark' ? 'bg-[#1A2332] border border-gray-700' : 'bg-[#bed8c0]/30 backdrop-blur-sm border border-[#bed8c0]/50'}`}>
  ...
  return (
    <div
      className={`rounded-lg shadow-sm hover:shadow-md transition-shadow cursor-pointer p-4 h-auto ${theme === 'dark' ? 'bg-[#1A2332] border border-gray-700 hover:border-blue-500/50' : 'bg-[#bed8c0]/30 backdrop-blur-sm border border-[#bed8c0]/50 hover:border-[#bed8c0]/80'}`}
