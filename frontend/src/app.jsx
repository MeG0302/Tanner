...
function MarketCard({ market, onMarketClick }) {
  ...
  if (outcomes.length === 0) {
    return (
      <div className="bg-blue-50 border border-blue-200 rounded-lg shadow-sm p-4 h-auto">
        <span className="text-xs text-blue-400 uppercase">{market.category}</span>
  ...
  return (
    <div
      className="bg-blue-50 border border-blue-200 rounded-lg shadow-sm hover:shadow-md transition-shadow cursor-pointer p-4 h-auto"
